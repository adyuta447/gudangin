                ...
                <div className="mx-auto max-w-350 px-6 py-8 lg:px-10">
                    <header className="mb-10 flex items-start justify-between">
                        <div>
                            ...
                            <p className="mt-2 font-sans text-base text-gd-muted">
                                {staffMembers.length} akun staff terdaftar
                            </p>
                        </div>
                        <button
                            onClick={() => {
                    ...
                    <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
                        {staffMembers.map((staff) => (
                            <div
                                key={staff.id}
                                className="rounded-2xl border border-gd-hairline bg-gd-surface-card p-6 transition-all duration-200 hover:border-gd-coral/30"
                            >
                                <div className="mb-4 flex items-start justify-between">
                                    ...
                                    <div className="flex items-center gap-1">
                                        <button
                                            ...
                                            className="rounded-lg p-1.5 text-gd-muted transition-colors hover:bg-gd-surface-soft hover:text-gd-ink"
                                        >
                                        ...
                                        <button
                                            onClick={() => {
                                                if (
                                                    confirm(
                                                        `Hapus akun ${staff.name}?`,
                                                    )
                                                ) {
                                                    router.delete(
                                                        `/staff-management/${staff.id}`,
                                                    );
                                                }
                                            }}
                                            className="rounded-lg p-1.5 text-gd-muted transition-colors hover:bg-gd-coral/10 hover:text-gd-coral"
                                        >
                                ...
                                <div className="grid grid-cols-3 gap-3 border-t border-gd-hairline/50 pt-4">
                                    <div className="text-center">
                                        ...
                                        <p className="font-sans text-xs font-bold text-gd-teal">
                                            Staff
                                        </p>
                                    </div>
                                    <div className="text-center">
                                        ...
                                        <p className="font-sans text-sm font-bold text-gd-ink">
                                    ...
                                    <div className="text-center">
                                        ...
                                        <p className="mt-1 font-sans text-xs font-medium text-gd-body">
                                            {staff.lastActivity}
                                        </p>
                                    </div>
                                </div>

                                <p className="mt-3 font-sans text-xs text-gd-muted-soft">
                                    Dibuat {staff.createdAt}
                                </p>
                            </div>
                        ))}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-gd-ink/40 backdrop-blur-sm">
            <div className="w-full max-w-lg rounded-2xl border border-gd-hairline bg-gd-surface-card p-8 shadow-xl">
                <div className="mb-6 flex items-center justify-between">
                    <h2 className="font-serif text-xl font-semibold text-gd-ink">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        ...
                        />
                        {errors.name && (
                            <p className="mt-1 text-xs text-gd-coral">
                                {errors.name}
                            </p>
                        )}
                    </div>
                    ...
                    <div>
                        <label className="mb-1 block font-sans text-sm text-gd-muted">
                            Password{' '}
                            {isEdit && (
                                <span className="text-gd-muted-soft">
